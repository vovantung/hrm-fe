        ...
        <Grid container spacing={6}>
          ...
          <Grid size={{ xs: 12 }}>
            <div className='overflow-x-auto border rounded'>
              <table className={tableStyles.table} style={{ fontSize: '13px' }}>
                <thead className='border-bs-0'>
                  <tr>
                    <th className='!bg-transparent'>Đơn vị</th>
                    <th className='!bg-transparent'>Tên báo cáo</th>
                    <th className='!bg-transparent'>Ngày báo cáo</th>
                  </tr>
                </thead>
                <tbody>
