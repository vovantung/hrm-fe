...
const FilterWeeklyReportSidebar = () => {
  ...
  async function handleReportedFromTo() {
    try {
      ...
      const res1 = await fetch(globalVariables.url_report + '/user/weekly-reports/current-department/reports', param)
      ...
      const res2 = await fetch(globalVariables.url_report + '/user/weekly-reports/summary/reports', param)
